...
test("date.canBeNotified", () => {
  expect(
    date.canBeNotified(
      ...
      +new Date("2020-10-20T14:00:00")
    )
  ).toBe(true);
  expect(
    date.canBeNotified(
      +new Date("2020-10-20T15:00:00"),
      +new Date("2020-10-20T13:00:00")
    )
  ).toBe(true);
  expect(
    date.canBeNotified(
      +new Date("2020-10-20T15:00:00"),
      +new Date("2020-10-20T12:45:39")
    )
  ).toBe(true);
  expect(
    date.canBeNotified(
      +new Date("2020-10-21T00:45:00"),
      +new Date("2020-10-20T23:45:00")
    )
  ).toBe(true);
  expect(
    date.canBeNotified(
  ...
  expect(
    date.canBeNotified(
      +new Date("2020-10-20T15:00:00"),
      +new Date("2020-10-20T15:00:01")
    )
  ).toBe(false);
  expect(
    date.canBeNotified(
      +new Date("2020-10-21T00:15:00"),
      +new Date("2020-10-20T23:45:00")
    )
  ).toBe(false);
});
...
test("date.wasLessThanXHoursAgo", () => {
  expect(
    date.wasLessThanXHoursAgo(
      +new Date("2020-10-20T15:00:00"),
      +new Date("2020-10-20T14:59:59"),
      1
    )
  ).toBe(true);
  expect(
